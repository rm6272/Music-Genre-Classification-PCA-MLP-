...
* Explored clustering structure using silhouette analysis
...
* **MLP Macro-AUC: ~0.924**
* Accuracy: ~56% (multi-class classification)
...
* PCA improves performance by reducing noise and redundancy
